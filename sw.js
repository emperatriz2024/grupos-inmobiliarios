...
const CACHE=`${CACHE_PREFIX}v0620-cloud-bridge-iphone-first`;
const V='?v=0620';
const ASSETS=[
  ...
  './version.js','./diagnostics.js','./core/property-policy.js','./external/adapters.js','./ingestion/source-ingestion.js','./ingestion/secondary-processing.js','./ingestion/secondary-sync-policy.js','./secondary-whatsapp/contract.js',
...
self.addEventListener('activate',event=>event.waitUntil((async()=>{
  ...
  clients.forEach(client=>client.postMessage({type:'RADAR_VERSION_READY',version:'0.6.2'}));
})()));
