const CACHE='grupos-inmobiliarios-v0512-hotfix-strict-price';
const V='?v=0512';
const ASSETS=['./','./index.html','./styles.css'+V,'./app.js'+V,'./db.js'+V,'./worker.js'+V,'./engine.js'+V,'./zip-reader.js'+V,'./search-utils.js'+V,'./date-utils.js'+V,'./contact-utils.js'+V,'./location-utils.js'+V,'./location-catalog.js'+V,'./intent-utils.js'+V,'./dedupe-utils.js'+V,'./dropbox.js'+V,'./buyer-utils.js'+V,'./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png'];
