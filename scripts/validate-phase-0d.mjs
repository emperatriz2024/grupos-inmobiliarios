...
assert.match(db,/const DB_VERSION = (?:10|11|12|13)/);assert.match(db,/runOpportunityReadiness/);assert.match(db,/READINESS_STORE,ENRICHMENT_TASK_STORE,PROPERTY_PACKAGE_STORE,PACKAGE_MEDIA_STORE/);
...
assert.match(version,/0\.7\.(?:3|4|5)-test/);assert.match(version,/V0\.7\.(?:3 READY \+ ENRICHMENT|4 CLIENT \+ BROKER TWIN|5 REVENUE OPERATIONS) TEST/);
