...
assert.match(db,/const DB_VERSION = 10/);assert.match(db,/runOpportunityReadiness/);assert.match(db,/READINESS_STORE,ENRICHMENT_TASK_STORE,PROPERTY_PACKAGE_STORE,PACKAGE_MEDIA_STORE/);
