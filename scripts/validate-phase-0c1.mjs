...
if(!/const DB_VERSION = (?:9|10|11|12|13|14)/.test(db)||!/DEMAND_SOURCE_STORE/.test(db)||!/market_identity/.test(db)||!/requester_identity/.test(db))throw new Error('IndexedDB demand scale incompleta.');
