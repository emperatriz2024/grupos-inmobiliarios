...
if(!/const DB_VERSION = (?:9|10|11)/.test(db)||!/DEMAND_SOURCE_STORE/.test(db))throw new Error('IndexedDB V9+ incompleta.');
console.log('Phase 0C.1 válido: lifecycle 7 días, demand_sources, estados e IndexedDB compatible.');
