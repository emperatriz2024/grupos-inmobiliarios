...
if(!/DB_VERSION = 7/.test(db)||!/BACKUP_STORES[\s\S]*OWN_LISTING_STORE/.test(db))throw new Error('Migración IndexedDB/backup 0B incompleta.');
console.log(`Phase 0B schema válido: ${required.length} tablas aditivas; IndexedDB V7.`);
