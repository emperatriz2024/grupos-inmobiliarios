...
if(!/const DB_VERSION = (?:8|9|10)/.test(db))throw new Error('IndexedDB no conserva compatibilidad 0C.');
...
if(!/APP_VERSION='0\.7\.2-(?:test|operativo)'/.test(version)||!/(?:V0\.7\.2 DEMAND \+ OPPORTUNITY TEST|RADAR OPERATIVO BETA)/.test(version))throw new Error('Versión 0C/operativa incorrecta.');
