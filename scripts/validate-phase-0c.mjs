...
if(!/const DB_VERSION = (?:8|9|10|11|12|13)/.test(db))throw new Error('IndexedDB no conserva compatibilidad 0C.');
...
if(!/APP_VERSION='0\.7\.(?:2|3|4|5)-test'/.test(version)||!/APP_LABEL='V0\.7\.(?:2 DEMAND \+ OPPORTUNITY|3 READY \+ ENRICHMENT|4 CLIENT \+ BROKER TWIN|5 REVENUE OPERATIONS) TEST'/.test(version))throw new Error('Versión TEST 0C+ incorrecta.');
